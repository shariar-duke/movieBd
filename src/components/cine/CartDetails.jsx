        ...
        {cartData?.map((cart, index) => (
          <div key={index} className="flex justify-between">
            <div className="flex gap-[16px]">
              {" "}
              <img height={60} width={60} src={getImgUrl(cart.cover)} alt="" />
              <div >
            ...
            <button onClick={(e)=>handleDeleteMovie(e,cart.id)} className="p-[8px] flex gap-[6px] text-sm font-semibold bg-[#D42967] rounded-md justify-center w-[100px]">
              <img
                className="mt-[2px]"
                src={del}
                alt="delete"
